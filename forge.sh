...
echo "spready" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	spready localhost/' /etc/hosts
hostname spready
...
PASSWORD=$(mkpasswd 0b2XUNAQ5GTdACXHmMr9)
...
# Laravel Forge
ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAAAgQDNFKMY8IzoPHlswxAQK+qdqne5pr7z1/la9DyEntTerZGzBiZERmZIgJV0QU22FObg4WBDcSZpzaXvQozBwMs2cgvAIJsMou7pNj+WNv2OCtiv4MJ+8ZsHwHXC2nmbO6YnPFweyd0C1cBWJ/qDr41fssD1/VT3bFMl7yy9cr7daw== phpseclib-generated-key
EOF
...
git config --global user.email "danyrod94@gmail.com"
...
echo "forge ALL=NOPASSWD: /usr/sbin/service php5-fpm reload" > /etc/sudoers.d/php5-fpm
...
debconf-set-selections <<< "mysql-server mysql-server/root_password password 8EGwTbMSzKe57cNljmHZ"
debconf-set-selections <<< "mysql-server mysql-server/root_password_again password 8EGwTbMSzKe57cNljmHZ"
...
mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "GRANT ALL ON *.* TO root@'192.168.3.3' IDENTIFIED BY '8EGwTbMSzKe57cNljmHZ';"
mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "GRANT ALL ON *.* TO root@'%' IDENTIFIED BY '8EGwTbMSzKe57cNljmHZ';"
service mysql restart

mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "CREATE USER 'forge'@'192.168.3.3' IDENTIFIED BY '8EGwTbMSzKe57cNljmHZ';"
mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "GRANT ALL ON *.* TO 'forge'@'192.168.3.3' IDENTIFIED BY '8EGwTbMSzKe57cNljmHZ' WITH GRANT OPTION;"
mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "GRANT ALL ON *.* TO 'forge'@'%' IDENTIFIED BY '8EGwTbMSzKe57cNljmHZ' WITH GRANT OPTION;"
mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "FLUSH PRIVILEGES;"

# Create The Initial Database If Specified

mysql --user="root" --password="8EGwTbMSzKe57cNljmHZ" -e "CREATE DATABASE spread;"
...
sudo -u postgres psql -c "CREATE ROLE forge LOGIN UNENCRYPTED PASSWORD '8EGwTbMSzKe57cNljmHZ' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
service postgresql restart

# Create The Initial Database If Specified

sudo -u postgres /usr/bin/createdb --echo --owner=forge spread
...
curl --insecure --data "event_id=1609046&server_id=33037&sudo_password=0b2XUNAQ5GTdACXHmMr9&db_password=8EGwTbMSzKe57cNljmHZ" https://forge.laravel.com/provisioning/callback/app
